# 🤖 Projeto Chapolin - Frases Aleatórias

## 📖 Sobre o Projeto
Este projeto foi desenvolvido em **JavaScript** pela escola **TAT - Talking About Testing**.  
...
- Atualizar a frase ao clicar em um botão  
